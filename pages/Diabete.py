...
def get_results(input,states):
    ...
    return html.H2(f'{result} (probabilité de {model.predict_proba(df_test)[0][0 if result == "Absence de diabète" else 1] * 100 :.2f}%)', className='text-white card-title text-center p-4')